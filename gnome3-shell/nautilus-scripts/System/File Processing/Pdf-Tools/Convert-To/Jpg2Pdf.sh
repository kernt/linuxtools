#!/bin/sh
#Nautilus Script to convert selected JPG files to a multi-page PDF file
#V.1.0
#Requires "imagemagick" package which includes "convert"
#Please Note: This script assumes all the selected files have the same (case sensitive) jpg extension
...
#process tmp files 
convert "$HOME/.local/share/nautilus/tmp/*.jpg" "$PWD/Merged.pdf"
#remove temp files
